...
import (
	"context"
	"fmt"
	flags2 "github.com/alan1-666/solana-wallet/flags"
	"github.com/ethereum/go-ethereum/params"

	sol_wallet "github.com/alan1-666/solana-wallet"
	"github.com/alan1-666/solana-wallet/api"
	"github.com/alan1-666/solana-wallet/common/cliapp"
	...
	"github.com/alan1-666/solana-wallet/services"
...
func runSolWallet(ctx *cli.Context, shutdown context.CancelCauseFunc) (cliapp.Lifecycle, error) {
	...
	return sol_wallet.NewSolWallet(ctx.Context, &cfg, shutdown)
}
